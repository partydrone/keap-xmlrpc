module Keap
  module XMLRPC
    class Client
      ...
      #
      # @see https://developer.keap.com/docs/rest/#!/Account_Info
      module AccountInfo
        # Retrieves profile/company info for an account.
        #
        # @return [AccountProfile] an account profile object
        # @see https://developer.keap.com/docs/rest/#!/Account_Info/getAccountProfileUsingGET
        def account
        ...
        # @return [AccountProfile] an account profile object
        # @see https://developer.keap.com/docs/rest/#!/Account_Info/updateAccountInfoUsingPUT
